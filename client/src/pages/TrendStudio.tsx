...
import { analyzeBusinessTrends, getTopicDeepDive, generatePostLeads } from '../services/trend';
import { AnalysisReport, TopicBubble, SocialPost, LeadProfile, Platform, TrendAppStatus } from '../types/trend';
...
import { Search, Youtube, Users, FileText, ArrowRight, Loader2, Instagram, Facebook, Twitter, X, ExternalLink, MessageCircle, Heart, Eye, Share2, Download, CheckCircle2, MessageSquare } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-20 relative">
            ...
            {selectedTopic && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="bg-slate-950 border border-slate-700 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col relative z-10 animate-fade-in-up">
                        ...
                        <div className="p-6 border-b border-slate-800 flex items-center justify-between sticky top-0 bg-slate-950 z-20">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    onClick={() => {
                                        // Construct a rich prompt based on the trend data
                                        const persona = data?.audience?.[0]; // Use primary persona
                                        ...
                                        // Navigate to Story Studio with prefilled data
                                        navigate('/studio', {
                                            state: {
                                                appMode: AppMode.STORY_STUDIO,
                                                prefilledTopic: prompt,
                                                prefilledAudience: 'Student', // Could infer this better
                                                prefilledPlatform: platform
                                            }
                                        });
                                    }}
                                    className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white text-xs font-bold rounded-lg flex items-center gap-2 transition-all shadow-lg hover:shadow-indigo-500/25"
                                >
